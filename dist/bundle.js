...
var ADD_TO_DO_CHANGED = exports.ADD_TO_DO_CHANGED = "ADD_TO_DO_CHAGED";

var SAVE_NEW_TO_DO = exports.SAVE_NEW_TO_DO = "SAVE_NEW_TO_DO";

var TOGGLE_STATUS = exports.TOGGLE_STATUS = "TOGGLE_STATUS";

function addTodoChanged(value) {
    return {
...
var _AddNewTodo = __webpack_require__(74);
...
function todoListApp(state, action) {
    ...
    var todoList = modifiedState.todoList.slice(); //need to add .slice() to keep immutability
    var newTodoItem = {};
    var idCounter = todoList[todoList.length - 1].id;

    switch (action.type) {
        case _actions.ADD_TO_DO_CHANGED:
            modifiedState = Object.assign({}, modifiedState, { "addTodoValue": action.value });
            break;

        case _actions.SAVE_NEW_TO_DO:
            newTodoItem.id = idCounter + 1;
            newTodoItem.key = idCounter + 1;
            newTodoItem.text = modifiedState.addTodoValue;
            newTodoItem.status = 0;
            todoList.push(newTodoItem);
            modifiedState = Object.assign({}, modifiedState, { todoList: todoList, "addTodoValue": "" });
            break;
        case _actions.TOGGLE_STATUS:
            ...
            modifiedState = Object.assign({}, modifiedState, { todoList: todoList });
            break;
